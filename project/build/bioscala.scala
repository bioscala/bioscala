...
{
  override def unmanagedClasspath = super.unmanagedClasspath +++ ("lib" / "scala" / "biojava" / "core" / "3.0-SNAPSHOT" / "core-3.0-SNAPSHOT.jar") +++ ("lib" / "scala" / "biojava" / "alignment" / "3.0-SNAPSHOT" / "alignment-3.0-SNAPSHOT.jar") 
